namespace VRTK.Examples
{
    ...
    public class VRTK_ControllerEvents_ListenerExample : MonoBehaviour
    {
        ...
        private void DebugLogger(uint index, string button, string action, ControllerInteractionEventArgs e)
        {
			...
			jsonObject.AddField ("controllerIndex", index);
			jsonObject.AddField ("button", button);
			jsonObject.AddField ("action", action);
			jsonObject.AddField ("buttonPressure", e.buttonPressure);
			jsonObject.AddField ("touchpadAxis", JSONTemplates.FromVector2(e.touchpadAxis));
			jsonObject.AddField ("touchpadAngle", e.touchpadAngle);
			jsonObject.AddField ("message", "buttonEvent");

			//socket.Emit ("buttonEvent", jsonObject);
			UdpSocket.Instance.UDPSend (jsonObject.ToString ());
        }
        ...
        private void DoTriggerPressed(object sender, ControllerInteractionEventArgs e)
        {
			...
			if (name.Contains ("Left"))
				jsonObject.AddField ("controller", "left");
			else
				jsonObject.AddField ("controller", "right");

			//socket.Emit ("show", jsonObject);
			jsonObject.AddField("message", "show");
			UdpSocket.Instance.UDPSend (jsonObject.ToString ());
        }
        ...
        private void DoGripPressed(object sender, ControllerInteractionEventArgs e)
        {
			...
			//socket.Emit ("hide", jsonObject);
			jsonObject.AddField("message", "hide");
			UdpSocket.Instance.UDPSend (jsonObject.ToString ());
        }
